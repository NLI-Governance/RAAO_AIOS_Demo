...
training_titles = catalog_df["Training Name"].tolist()
expiration_lookup = dict(zip(catalog_df["Training Name"], catalog_df["Expiration Policy"]))
...
with st.form("training_form"):
    ...
    st.write(f"🗓️ Certification expires on: **{expiration}**")
